window.MMT_ANGLE_ENGINE = (() => {
  ...
  function svg() {
    ...
    style.textContent = `
      ...
      /* Clean worksheet-style angle diagrams.  The earlier version used heavy
         black strokes, two strong arc colours and visible vertex dots; this
         version uses lighter vector strokes and a single clean accent, closer
         to the reference worksheets. */
      .ray,.baseLine{
        stroke:#2faa45;
        stroke-width:2.45;
      ...
      .arc.green,.arc.orange{stroke:#2faa45}
      .parallelArc{stroke:#b21f3d}
      ...
      .vertexDot{fill:#111827;opacity:0}
      .rightMarker,.parallelMarker{
        stroke:#2faa45;
        stroke-width:2;
        stroke-linecap:round;
        stroke-linejoin:round;
      ...
      .parallelMarkerRed{stroke:#b21f3d}
  ...
  function arcColour(cls) {
    ...
    if (className.includes("parallelArc")) return "#b21f3d";
    return "#2faa45";
  }
  ...
  function dot(svg, cx, cy) {
    svg.appendChild(el("circle", { cx, cy, r: 2, class: "vertexDot" }));
  }
